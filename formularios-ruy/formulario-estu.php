...
$listarEquipamentosEst = buscarEquipamentosEst($conexao);

// var_dump($listarEquipamentosEst); 
...
$nSerie = filter_input(INPUT_POST,'fonte', FILTER_SANITIZE_SPECIAL_CHARS );
...
<main>
    <section>
            <fieldset>
                ...
                <p><label for="equipamento">Equipamento - Estudantes</label></p>
                ...
                <select name="equipamento" id="equipamento" required>
                    ...
                    foreach ($listarEquipamentosEst as $equipEst) { ?>

                    <option value="<?=$equipEst['id']?>">  <?=$equipEst['n_serie']?>  </option>
